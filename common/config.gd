...
# Шар живёт по физике тела: та же кривая отскока, та же гравитация уровня.
# Своих чисел у него два — радиус и пауза перед возвращением после падения.
const BALL_RADIUS := 9.0           # вдвое с лишним меньше тела: мелкая цель
